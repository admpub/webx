...
require (
	github.com/admpub/nging/v5 v5.3.4-0.20251227133814-e771808edd15
	github.com/coscms/webcore v0.13.3-0.20251228104019-f8999af76938
	github.com/coscms/webfront v0.0.0-20251228071722-6f245203987e
)
