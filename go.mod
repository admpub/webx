...
require (
	github.com/admpub/nging/v5 v5.3.4-0.20260310053511-cc5758a98b26
	github.com/coscms/webcore 27db8a8cc69d6056d3528e72fda1850aee3f32ca
	github.com/coscms/webfront v0.0.0-20260310065904-9c1d7058627e
)
