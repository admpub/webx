...
require (
	github.com/admpub/nging/v5 v5.3.6-0.20260727051035-3317746ed4cf
	github.com/coscms/webcore v0.13.3-0.20260805064346-d805a15b2f76
	github.com/coscms/webfront v0.0.0-20260714004729-9d5241d33414
)
