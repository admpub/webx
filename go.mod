...
require (
	github.com/admpub/nging/v5 v5.3.4-0.20260311051351-f5ca77615444
	github.com/coscms/webcore v0.13.3-0.20260312041407-72fede998927
	github.com/coscms/webfront v0.0.0-20260312044215-d7d61807f63f
)
