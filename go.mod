...
require (
	github.com/admpub/nging/v5 v5.3.4-0.20250815145246-f0f6aaf3f1ef
	github.com/coscms/webcore v0.9.44-0.20250816012022-f93e730df70a
	github.com/coscms/webfront v0.0.0-20250816012137-3027b34b4630
)
