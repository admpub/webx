...
require (
	github.com/admpub/nging/v5 v5.3.4-0.20251122102211-294c556ef9a4
	github.com/coscms/webcore v0.13.3-0.20251122121006-cefa64109da1
	github.com/coscms/webfront v0.0.0-20251122113504-e23dfdb2ab0a
)
