...
require (
	github.com/admpub/nging/v5 v5.3.4-0.20250727035244-bfe066caa518
	github.com/coscms/webcore v0.9.31-0.20250728042520-09c216e911d0
	github.com/coscms/webfront v0.0.0-20250729135934-1c08db881c4c
)
